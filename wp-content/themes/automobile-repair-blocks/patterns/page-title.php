...
/**
 * Title: Page Title
 * Slug: automobile-repair-blocks/page-title
 * Categories: automobile-repair-blocks, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri().'/images/inner-banner.jpg' ); ?>","id":6,"dimRatio":50,"minHeight":300} -->
