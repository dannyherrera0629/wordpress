...
/**
 * Title: Header Image
 * Slug: automobile-repair-blocks/header-image
 * Categories: automobile-repair-blocks, header-image
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.jpg'); ?>","id":15,"dimRatio":50,"minHeight":300} -->
